<template>
    ...
    <form class="form mt-6 max-w-xl" @submit.prevent="submit">
        ...
        <div v-if="mustVerifyEmail">
            ...
            <div class="text-success" v-show="status === 'verification-link-sent'">
            ...
            <template #content="field">
                <div class="control field">
                    ...
                    <div class="flex justify-between w-full">
                        <secondary-button class="!px-12" v-for="(name, locale) in meta.locales"
...
const submit = () => {
    form.patch(route('users.update', {user: auth.id}));
};
</script>
